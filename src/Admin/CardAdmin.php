...
class CardAdmin extends MainAdmin
{
    ...
    protected function configureShowFields(ShowMapper $showMapper)
    {
        ...
        if ($this->isCurrentRoute('history_view_revision')) {
            $showMapper
                ->tab('Номинальные')
                    ->with("left", ['class' => 'col-md-12', 'description' => 'Описание', 'label' => 'Характеристики'])
    ...
    protected function configureListFields(ListMapper $listMapper)
    {
        ...
        $listMapper
            ->add('pipeSerialNumber', null, array_merge(self::VIEW_LINK, ['label' => 'Серийный № трубы', 'sortable' => true,]))
