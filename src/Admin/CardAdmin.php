...
class CardAdmin extends AbstractAdmin
{
    ...
    protected function configureFormFields(FormMapper $formMapper)
    {
        $formMapper
            ...
            ->add('ref_warehouse', null, ['label' => '№ Склада'])
            ...
            ->add('ref_inner_coating', null, ['label' => 'Внутреннее покрытие'])
            ->add('ref_hardbanding_nipple', null, ['label' => 'Хардбендинг (ниппель)'])
            ->add('ref_hardbanding_coupling', null, ['label' => 'Хардбендинг (муфта)'])
